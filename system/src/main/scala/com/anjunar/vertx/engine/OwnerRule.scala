...
case class OwnerRule[E <: OwnerProvider]() extends VisibilityRule[E] {
  override def isVisible(entity: E, property: String, ctx: RequestContext, factory: Stage.Session): CompletionStage[Boolean] = CompletableFuture.completedFuture(true)

...
object SearchBeanReader {
  ...
  def read[E](search: AnyRef, entityManager: Stage.Session, builder: CriteriaBuilder, root: Root[E], query: CriteriaQuery[?]): (mutable.Buffer[Predicate], mutable.Map[String, Any], mutable.Buffer[Expression[java.lang.Double]]) = {
  ...
  def order[E](search: AnyRef, entityManager: Stage.Session, builder: CriteriaBuilder, root: Root[E], query: CriteriaQuery[?], selection : Expression[java.lang.Double], predicates : mutable.Buffer[Predicate]): Array[Order] = {
    val beanModel = DescriptionIntrospector.createWithType(search.getClass)
